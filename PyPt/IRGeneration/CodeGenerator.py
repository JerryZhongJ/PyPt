...
class CodeBlockGenerator(ast.NodeVisitor):
    ...
    def addNewFunction(self, target: Variable, codeBlock: FunctionCodeBlock, id: int):
        if(target):
            NewFunction(target, codeBlock, self.codeBlock, id)
        
    def addNewClass(self, target: Variable, bases: List[Variable], codeBlock: ClassCodeBlock, id: int):
        if(target):
            NewClass(target, bases, codeBlock, self.codeBlock, id)
    ...
    def visit_Import(self, node: ast.Import):
        ...
        callerName = self.codeBlock.module.id
    ...
    def visit_ImportFrom(self, node: ast.ImportFrom):
        ...
        callerName = self.codeBlock.module.readable_name
